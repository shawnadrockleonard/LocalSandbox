...
namespace WebIdentityServer.Helpers
{
    ...
    {
        const string RoleTypeName = "Federation";
        ...
        public static void Log(LogEntryType logEntryType, string message, string[] operationProperties, HttpContext httpContext = null)
        {
            Log(new LogEntry
            {
                Operation = message,
        ...
        private static void LogDestinationIPs(string key, string hostNameOrAddress)
        {
            ...
            if (ipAddresses.Count > 0)
            {
                Log(new LogEntry
                {
                    ...
                    Operation = $"Remote Connection IP for '{key}'",
                    OperationProperties = ipAddresses.ToArray(),
                    Role = RoleTypeName
                });
            }
        }
